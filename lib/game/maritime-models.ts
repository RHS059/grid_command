...
export function maritimeGeometry(role:Role,side:Side){
  const parts:T.BufferGeometry[]=[],large=['FRIGATE','AIRCRAFT_CARRIER'].includes(role),length=role==='AIRCRAFT_CARRIER'?64:large?70:role==='LANDING_CRAFT'?18:10,width=role==='AIRCRAFT_CARRIER'?15:large?10:5
