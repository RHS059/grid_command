...
## Strategic cargo plane (v2.0.4)

CARGO_PLANE now uses lib/game/reference-aircraft.ts. The previous four-turboprop constructor is superseded visually. Use the supplied large strategic airlifter photograph for its broad long fuselage, high swept wings, four separate underwing jet nacelles, tall swept vertical fin with a horizontal stabilizer at its top, and multiple landing-gear bogies. Apply the heavy lift VTOL's pale #b1b7b4 faceted skin, dark #344b59 segmented cockpit, restrained metal #555f60 and small team panels. Keep this a conventional jet cargo plane, with no VTOL rotors.

Construct the fuselage from clipped longitudinal cross sections with a full-width cargo barrel, narrowed rounded-angular nose, raised dark cockpit and tapered rear. Give jet pods polygonal intake rings, recessed fan faces, small center spinners and dark stepped exhausts. Add substantial wing roots, thin control-surface seams, gear fairings and paired wheels. Merge stationary geometry by material. Keep cargo-ramp as a separate bottom-hinged group so the existing unloading animation can lower it. Existing logistics capacity, flight speed and missions are unchanged.
