...
$stats=Get-Content (Join-Path $outDir 'soldier_medium_static_verification.json') -Raw | ConvertFrom-Json
foreach($view in @('front','side','top_3quarter')) {
 ...
 $model=[System.Drawing.Image]::FromFile((Join-Path $outDir ('soldier_medium_r'+$Revision+'_'+$view+'.png')))
 $alpha=[System.Drawing.Bitmap]::FromFile((Join-Path $outDir ('soldier_medium_r'+$Revision+'_'+$view+'_alpha.png')))
 ...
 $g.DrawString(('REFERENCE '+$view),$font,[System.Drawing.Brushes]::White,15,5);$g.DrawString(('ASTRA MEDIUM '+$Revision),$font,[System.Drawing.Brushes]::White,655,5)
 $comparison.Save((Join-Path $outDir ('soldier_medium_'+$view+'_comparison.png')),[System.Drawing.Imaging.ImageFormat]::Png);$g.Dispose();$comparison.Dispose()
 ...
 $overlay.Save((Join-Path $outDir ('soldier_medium_'+$view+'_overlay.png')),[System.Drawing.Imaging.ImageFormat]::Png)
