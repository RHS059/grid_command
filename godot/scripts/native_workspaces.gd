...
func _set_team(value: int) -> void:
	...
	team = value
	if changed and selected_model in ["TRUCK","FORKLIFT","A29B","UAV_JAMMER","CARGO_PLANE","TRANSPORT_HELI","IFV","MOB","AIRFIELD"]:
